...
const User = (props) =>{
    ...
    const onSubmit = async(values)=>{
        if(img&&idImg){
            ...
            let idImage= await imageUpload(idImg)
        ...
        <div className={classes.creationPage}>
            <div className={classes.creationCard}>
                <div className={classes.cardHead}>
                    <h2> إنشاء حساب جديد لـ<span> محتاج</span></h2>
                    ...
                    >
                        <Form>
                            <div className={classes.addimage}>
                                ...
                                />
                                <label htmlFor="profimg">إدراج صورة شخصية</label>
                            </div>
                                   ...
                                   <input 
                                    ...
                                    />
                                    {
                                        ...
                                        <div className={classes.imgBox}>
                                            <img src={URL.createObjectURL(idImg)} alt="idimage"/>
                                            <span onClick={()=>setIdImg(null)}>
